CLASS zcl_bb_pushdata_so DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_bb_pushdata_so IMPLEMENTATION.
...
* If everything is successful display the message
  ...
  METHOD refresh.
    ...
    DELETE FROM : zbb_dt_so, zbb_dt_soit, zbb_dt_prod, zbb_dt_cust.
  ...
  METHOD enter_master_data.
    ...
    DATA: li_prod TYPE TABLE OF zbb_dt_prod,
          ls_prod TYPE zbb_dt_prod,
          li_cust TYPE TABLE OF zbb_dt_cust,
          ls_cust TYPE zbb_dt_cust.
    ...
    INSERT zbb_dt_prod FROM TABLE @li_prod.
    ...
    INSERT zbb_dt_cust FROM TABLE @li_cust.
  ...
  METHOD enter_transactional_data.
    ...
    DATA:
      li_so   TYPE TABLE OF zbb_dt_so,
      li_soit TYPE TABLE OF zbb_dt_soit.
...
TO li_so.
      ...
      INSERT zbb_dt_so FROM TABLE @li_so.
...
*                        image_item = image_item
        ...
        INSERT zbb_dt_soit FROM TABLE @li_soit.
        CLEAR li_soit.
